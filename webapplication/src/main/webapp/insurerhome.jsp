...
<script>
	...
	function viewPolicy() {
	document.getElementById("displayIframe").innerHTML="<iframe src ='InsuredViewPolicy' class ='userframe' height = '700' width = '500'></iframe>";
	}
...
<body>
	...
	<div class="adminHP">
		<div class="header">
			<button href="index.html" class="logo">CompanyLogo</button>
			<div class="header-right">
				<button class="active" href="LogoutServlet">Logout</button>
			</div>
		</div>
		</div>
